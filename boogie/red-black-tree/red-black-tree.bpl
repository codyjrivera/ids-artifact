...
function {:inline} Frame_black(mod_set: RefSet, old_black: [Ref]bool, black: [Ref]bool) returns ([Ref]bool)
{
    MapIte_Ref_bool(mod_set, black, old_black)
}

function {:inline} Frame_black_height(mod_set: RefSet, old_black_height: [Ref]int, black_height: [Ref]int) returns ([Ref]int)
{
    MapIte_Ref_int(mod_set, black_height, old_black_height)
}
